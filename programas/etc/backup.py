...
bici['descripcion_del_hecho - Final']= bici['descripcion_del_hecho - Final'].astype(str).apply(str.split)
peaton['descripcion_del_hecho - Final']=peaton['descripcion_del_hecho - Final'].astype(str).apply(str.split)
moto['descripcion_del_hecho - Final']=moto['descripcion_del_hecho - Final'].astype(str).apply(str.split)
auto['descripcion_del_hecho - Final']=auto['descripcion_del_hecho - Final'].astype(str).apply(str.split)
...
bici['descripcion_del_hecho - Final']= bici['descripcion_del_hecho - Final'].astype(str).apply(nlp)
peaton['descripcion_del_hecho - Final']=peaton['descripcion_del_hecho - Final'].astype(str).apply(nlp)
moto['descripcion_del_hecho - Final']=moto['descripcion_del_hecho - Final'].astype(str).apply(nlp)
auto['descripcion_del_hecho - Final']=auto['descripcion_del_hecho - Final'].astype(str).apply(nlp)
...
moto['Spacy Lemma-Pos'] = moto['descripcion_del_hecho - Final'].apply(Doc2Par)
auto['Spacy Lemma-Pos'] = auto['descripcion_del_hecho - Final'].apply(Doc2Par)
peaton['Spacy Lemma-Pos'] = peaton['descripcion_del_hecho - Final'].apply(Doc2Par)
